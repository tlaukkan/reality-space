export class Decode {
    ...
    static add(parts: string[]) : [string, number, number, number, number, number, number, number, string] {
        return [
            parts[1],
            parseFloat(parts[2]),
            parseFloat(parts[3]),
    ...
    static added(parts: string[]) : [number, string, number, number, number, number, number, number, number, string] {
        return [
            parseInt(parts[1]),
            parts[2],
            parseFloat(parts[3]),
