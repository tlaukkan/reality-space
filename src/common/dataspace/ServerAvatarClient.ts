import {ClusterClient} from "../../../lib/src";
...
export class ServerAvatarClient {
    ...
    async start() {
        const id = uuid.v4();
        const client: ClusterClient = new ClusterClient(this.clusterConfigurationUrl, id, 0, 0, 0, 0, 0, 0, 1, "<a-dodecahedron scale='0.5 0.5 0.5'></a-dodecahedron>");
