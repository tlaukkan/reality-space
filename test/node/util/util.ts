...
export function newLocalTestServer(): RealityServer {
    ...
    const server = new RealityServer('127.0.0.1', 8889, processor, storageRestService, [new IdTokenIssuer("test-issuer", "")]);
    return server;
}
